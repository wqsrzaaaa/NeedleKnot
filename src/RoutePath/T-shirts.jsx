    ...
    return (
      <div className='w-full !pt-20'>
        <div className='w-full h-[200px] flex-col flex justify-center gap-7 !pl-9'>
          <h1 className='text-2xl !pr-4 md:text-4xl'>Embroided T-Shirts / Drop shoulder</h1>
          <div className='w-full flex !pr-9 justify-between'>
             <div className='w-[40vh] md:w-[400px] items-center md:text-[20px] text-[13px] gap-3 flex '>
             <label>Sort By:</label>
              <select
             ...
             <p className='text-zinc-500 w-[120px] '>{Shirts.length} Items</p>
          </div>
        </div>
        <div className='w-full gap-6 !pb-9 flex-wrap flex justify-center '>
       {Shirts.map((e,i)=>(
         <Link key={i}
         to="/checkout"
         state={{ SelectedItem: e }}>
            <div key={i} className='w-[40vh] md:w-[60vh] h-[60vh] md:h-[80vh] flex flex-col items-center'>
